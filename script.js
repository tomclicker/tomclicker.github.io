window.onload = () => {
    ...
    if (maxWorldPeople < 1) {
        document.getElementById('worldPeople').style.display = 'none';
        document.getElementById('worldPic').style.display = 'none';
        document.getElementById('numInhabitants').style.display = 'none';
    }
    if (maxPlanetPeople < 1) {
        document.getElementById('planetPeople').style.display = 'none';
        document.getElementById('planetPic').style.display = 'none';
        document.getElementById('numPlanetarians').style.display = 'none';
    }
    if (maxGalaxyPeople < 1) {
        document.getElementById('galaxyPeople').style.display = 'none';
        document.getElementById('galaxyPic').style.display = 'none';
        document.getElementById('numMilkers').style.display = 'none';
    }
    ...
    function checkPrice() {
        ...
        if (loc > upgrade7Cost) {
            document.getElementById('upgrade7').style.backgroundColor = "#025993bd";
        ...
        if (loc > upgrade8Cost) {
            document.getElementById('upgrade8').style.backgroundColor = "#025993bd";
        ...
        if (loc > upgrade9Cost) {
            document.getElementById('upgrade9').style.backgroundColor = "#025993bd";
        ...
        if (loc > 50000000000) {
            document.getElementById('unlockU7').style.backgroundColor = "#025993bd";
        ...
        if (loc > 9000000000000) {
            document.getElementById('unlockU8').style.backgroundColor = "#025993bd";
        ...
        if (loc > 45000000000000) {
            document.getElementById('unlockU9').style.backgroundColor = "#025993bd";
        ...
        if (loc > people7Cost && russiaPeople < maxWorldPeople) {
            document.getElementById('worldPeople').style.backgroundColor = "#025993bd";
        ...
        if (loc > people8Cost && planetPeople < maxPlanetPeople) {
            document.getElementById('planetPeople').style.backgroundColor = "#025993bd";
        ...
        if (loc > people9Cost && galaxyPeople < maxGalaxyPeople) {
            document.getElementById('galaxyPeople').style.backgroundColor = "#025993bd";
        ...
        if (assignments >= 500000000) {
            document.getElementById('loc6').style.backgroundColor = "#025993bd";
        ...
        if (assignments >= 60000) {
            document.getElementById('loc3').style.backgroundColor = "#025993bd";
        ...
        if (assignments >= 1000000) {
            document.getElementById('loc4').style.backgroundColor = "#025993bd";
        ...
        if (assignments >= 1000000000) {
            document.getElementById('loc5').style.backgroundColor = "#025993bd";
        ...
        if (assignments >= 10000000000) {
            document.getElementById('loc7').style.backgroundColor = "#025993bd";
        ...
        if (assignments >= 3000000000000) {
            document.getElementById('loc8').style.backgroundColor = "#025993bd";
        ...
        if (assignments >= 40000000000000) {
            document.getElementById('loc9').style.backgroundColor = "#025993bd";
    ...
    function hideshow6() {
        if (loc >= 50000000000) {
            ...
            document.getElementById('worldPeople').style.display = 'block';
            document.getElementById('worldPic').style.display = 'block';
            document.getElementById('numInhabitants').style.display = 'block';
        }
    }
    ...
    function hideshow7() {
        if (loc >= 9000000000000) {
            ...
            document.getElementById('planetPeople').style.display = 'block';
            document.getElementById('planetPic').style.display = 'block';
            document.getElementById('numPlanetarians').style.display = 'block';
        }
    }
    ...
    function hideshow8() {
        if (loc >= 45000000000000) {
            ...
            document.getElementById('galaxyPeople').style.display = 'block';
            document.getElementById('galaxyPic').style.display = 'block';
            document.getElementById('numMilkers').style.display = 'block';
        }
    }
    ...
    if (loc > 1000000)
            setInterval(goldCircle, Math.random() * 120000 + 48000)
