...
window.onload = () => {
    ...
    function updateloc() {
        ...
        else if (nassignments >= 1000000000000000) {
            let displayAssignments = nassignments;
    ...
    document.getElementById("save").onclick = (event) => {
        ...
        localStorage.setItem('taCost', taCost.toString());
        ...
        if (maxStudents < 500000000) {
            if (assignments >= 60000000) {
                ...
                if (Math.floor(Math.random() * 10) == 1) {
                    ...
                    document.getElementById('loc10').style.display = 'block';
                }
            }
        }
    }
    //loc10
    document.getElementById("loc10").onclick = (event) => {
        event.preventDefault;
        if (maxStudents < 500000000000) {
            if (assignments >= 7000000000000) {
                assignments -= 7000000000000;
                if (Math.floor(Math.random() * 20) == 1) {
                    document.getElementById('loc10').style.backgroundColor = 'rgb(9, 145, 9)';
                    maxStudents = 500000000000;
                }
            }
        }
    }
    ...
    function assignmentClick() {
        assignments += aps * assMult * .01;
    }
    setInterval(assignmentClick, 10);
    ...
    //dean button
    document.getElementById("dean").onclick = (event) => {
        event.preventDefault();
        if (loc >= deanCost) {
            loc -= deanCost
            dps += 1
    ...
    document.getElementById('maxProfessors').style.backgroundColor = "#950740";
    document.getElementById('maxProfessors').style.color = "antiquewhite";

    document.getElementById('maxGC').style.backgroundColor = "#950740";
    document.getElementById('maxGC').style.color = "antiquewhite";

    document.getElementById('maxProjects').style.backgroundColor = "#950740";
    document.getElementById('maxProjects').style.color = "antiquewhite";

    document.getElementById('maxJobs').style.backgroundColor = "#950740";
    document.getElementById('maxJobs').style.color = "antiquewhite";

    document.getElementById('maxOrgs').style.backgroundColor = "#950740";
    document.getElementById('maxOrgs').style.color = "antiquewhite";

    document.getElementById('maxSoviets').style.backgroundColor = "#950740";
    document.getElementById('maxSoviets').style.color = "antiquewhite";

    document.getElementById('maxInhabitants').style.backgroundColor = "#950740";
    document.getElementById('maxInhabitants').style.color = "antiquewhite";

    document.getElementById('maxPlanetarians').style.backgroundColor = "#950740";
    document.getElementById('maxPlanetarians').style.color = "antiquewhite";

    document.getElementById('maxMilkers').style.backgroundColor = "#950740";
    document.getElementById('maxMilkers').style.color = "antiquewhite";

    document.getElementById('maxAgents').style.backgroundColor = "#950740";
    document.getElementById('maxAgents').style.color = "antiquewhite";

    //max buttons
    document.getElementById('maxProfessors').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people1Cost);
        for (k = 0; k < times; k++) {
            if (eastHallPeople == maxEHPeople)
                return;
            else {
                eastHallPeople++;
                aps += .4;
    ...
    document.getElementById('maxGC').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people2Cost);
        for (k = 0; k < times; k++) {
            if (beacomPeople == maxBeacomPeople)
                return;
            else {
                beacomPeople++;
                aps += 4.4;
    ...
    document.getElementById('maxProjects').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people3Cost);
        for (k = 0; k < times; k++) {
            if (madLabsPeople == maxMadLabsPeople)
                return;
            else {
                madLabsPeople++;
                aps += 13.8;
    ...
    document.getElementById('maxJobs').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people4Cost);
        for (k = 0; k < times; k++) {
            if (dsuPeople == maxDsuPeople)
                return;
            else {
                dsuPeople++;
                aps += 83.2;
    ...
    document.getElementById('maxOrgs').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people5Cost);
        for (k = 0; k < times; k++) {
            if (usaPeople == maxUsaPeople)
                return;
            else {
                usaPeople++;
                aps += 152;
    ...
    document.getElementById('maxSoviets').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people6Cost);
        for (k = 0; k < times; k++) {
            if (russiaPeople == maxRussiaPeople)
                return;
            else {
                russiaPeople++;
                aps += 782;
    ...
    document.getElementById('maxInhabitants').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people7Cost);
        for (k = 0; k < times; k++) {
            if (worldPeople == maxWorldPeople)
                return;
            else {
                worldPeople++;
                aps += 24560;
    ...
    document.getElementById('maxPlanetarians').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people8Cost);
        for (k = 0; k < times; k++) {
            if (planetPeople == maxPlanetPeople)
                return;
            else {
                planetPeople++;
                aps += 1830000;
    ...
    document.getElementById('maxMilkers').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people9Cost);
        for (k = 0; k < times; k++) {
            if (galaxyPeople == maxGalaxyPeople)
                return;
            else {
                galaxyPeople++;
                aps += 2600000;
    ...
    document.getElementById('maxAgents').onclick = (event) => {
        event.preventDefault();
        var k;
        let times = Math.floor(loc / people10Cost);
        for (k = 0; k < times; k++) {
            if (matrixPeople == maxMatrixPeople)
                return;
            else {
                matrixPeople++;
                aps += 1000000000;
    ...
    function checkPrice() {
        ...
        if (assignments >= 7000000000000) {
            document.getElementById('loc10').style.backgroundColor = "#950740";
            document.getElementById('loc10').style.color = "antiquewhite";
        }
        else {
            document.getElementById('loc10').style.backgroundColor = "#3d3b3c";
            document.getElementById('loc10').style.color = "#6a6767";
        }
        ...
        if (loc >= 500000000000) {
            document.getElementById('dean').style.backgroundColor = "#950740";
            document.getElementById('dean').style.color = "antiquewhite";
        }
        else {
            document.getElementById('dean').style.backgroundColor = "#3d3b3c";
            document.getElementById('dean').style.color = "#6a6767";
        }
